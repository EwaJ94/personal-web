...
const HomePage = () => {
  return <main id="home-page" className="h-[100vh] flex flex-col justify-end items-center text-[#cbcfcd] lg:flex-row-reverse lg:justify-evenly">
    <div
    className="flex flex-col justify-center items-center">
      ...
      <div className="flex justify-between w-20 pt-5">
        ...
        <a href="linkedin.com/in/ewa-jochymková-59770a287" className=""><img src={linkedin} alt="LinkedIn link" className="h-9" /></a>
      </div>
    </div>
    <div>
